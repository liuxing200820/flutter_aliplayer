...
class AliPlayer extends StatefulWidget {
  ...
  /// The [AliPlayerController] responsible for the video being rendered in
  /// this widget.
...
class _VideoScrubberState extends State<_VideoScrubber> {
  ...
  AliPlayerController get controller => widget.controller;
...
class VideoProgressIndicator extends StatefulWidget {
  ...
  /// The [AliPlayerController] that actually associates a video with this
  /// widget.
  final AliPlayerController controller;
